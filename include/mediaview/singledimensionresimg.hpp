...
*/
class mv::SingleDimentionResImg : public ResImg
{
    public:
        SingleDimentionResImg() : ResImg() {}
        SingleDimentionResImg(const std::string &file, ResizeDir resdir) : ResImg(file), resdir(resdir) {}
        SingleDimentionResImg(Glib::RefPtr<Gdk::Pixbuf> pixbuf, ResizeDir resdir) : ResImg(pixbuf), resdir(resdir) {}

        virtual ~SingleDimentionResImg(){}
